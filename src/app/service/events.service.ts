...
export class EventsService {
  ...
  public addEvent(event) {
	...
	const body = {events: event, username: sessionStorage.getItem('username')};
  ...
  {
	return this.httpClient.get<Object>('http://localhost:8080/events/eventNotifications/'+sessionStorage.getItem('username'));
  }
  public updateNotification() {
    return this.httpClient.post<Object>("http://localhost:8080/events/updateNotification", sessionStorage.getItem('username'));
  }
